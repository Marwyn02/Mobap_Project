...
export default function Result3() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.resultTitle}>Quiz 3 Result</Text>
      ...
      {percentage < 80 ? (
        ...
        <View>
          <Text style={styles.passMessage}>You've passed the Quiz 3!</Text>
          <Text style={styles.proceedMessage}>
            Click the proceed to continue to Level 4.
          </Text>
        </View>
      )}
